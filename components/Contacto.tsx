  ...
  return (
    <section id="contacto" className="py-32 px-6 border-t border-neutral-900/50 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {/* 
          Nota de Netlify: Al agregar 'data-netlify="true"', 
          Netlify automáticamente detecta este form en el build y captura los datos. 
        */}
        <form 
        ...
        >
          {/* Input oculto requerido por Netlify */}
          ...
          <div className="space-y-2 mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <label className="flex items-center gap-3 p-4 border border-neutral-800 rounded-lg cursor-pointer hover:border-blue-500 transition-all bg-neutral-950/50 group">
                <input type="radio" name="modelo" value="setup" className="w-4 h-4 accent-blue-500" />
              ...
              <label className="flex items-center gap-3 p-4 border border-blue-600/50 rounded-lg cursor-pointer bg-blue-900/10 hover:border-blue-500 transition-all group">
                <input type="radio" name="modelo" value="agencia" className="w-4 h-4 accent-blue-500" />
                <span className="text-sm font-semibold text-blue-400 group-hover:text-blue-300">Agencia Premium (Recomendado)</span>
              </label>
              <label className="flex items-center gap-3 p-4 border border-neutral-800 rounded-lg cursor-pointer hover:border-blue-500 transition-all bg-neutral-950/50 group">
                <input type="radio" name="modelo" value="inversionista" className="w-4 h-4 accent-blue-500" />
          ...
          <button type="submit" 
            className="w-full bg-white text-black font-bold text-lg py-4 rounded-lg hover:bg-neutral-200 transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)]">
            Solicitar Evaluación de Cuenta
          </button>
          
          <p className="text-center text-xs text-neutral-500 mt-6 flex items-center justify-center gap-2">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
            Capacidad actual: Aceptando 2 nuevos clientes este mes.
          </p>
        </form>
      </div>
    </section>
