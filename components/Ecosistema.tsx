...
export default function Ecosistema() {
  return (
    <section className="py-24 px-4 md:px-6 max-w-7xl mx-auto">
      ...
      {/* Grid Bento Box - SOLUCIÓN: Agregamos "md:" antes de auto-rows-[200px] para que en celular el alto sea libre */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:auto-rows-[200px]">
        
        {/* Box 1: Amazon & Mercado Libre */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          className="md:col-span-2 md:row-span-2 relative overflow-hidden rounded-3xl border border-neutral-800 group hover:border-blue-500/50 transition-all flex flex-col min-h-[420px] md:min-h-0"
        >
          ...
          <div className="relative z-10 p-6 md:p-8 flex flex-col justify-end flex-grow">
            <ShoppingBag className="w-10 h-10 text-blue-400 mb-4 mt-auto md:mt-0" />
        ...
        {/* Box 2: TikTok Shop & Social */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1 }}
          className="md:col-span-2 md:row-span-1 bg-neutral-900/50 border border-neutral-800 rounded-3xl p-6 md:p-8 relative group hover:border-pink-500/50 transition-all flex flex-col justify-center"
        >
          <div>
        ...
        {/* Box 3: Custom Domains & D2C */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.2 }}
          className="md:col-span-1 md:row-span-2 bg-neutral-900/50 border border-neutral-800 rounded-3xl p-6 md:p-8 relative group hover:border-emerald-500/50 transition-all flex flex-col"
        >
        ...
        {/* Box 4: Supply Chain & Dropshipping */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.3 }}
          className="md:col-span-1 md:row-span-1 bg-neutral-900/50 border border-neutral-800 rounded-3xl p-6 relative group hover:border-white/50 transition-all flex flex-col justify-center"
        >
        ...
        {/* Box 5: Manufactura 3D */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.4 }}
          className="md:col-span-2 md:row-span-1 bg-gradient-to-r from-blue-900/20 to-indigo-900/20 border border-indigo-500/30 rounded-3xl p-6 relative flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6 group hover:border-indigo-400 transition-all"
        >
          <div className="bg-indigo-500/20 p-4 rounded-2xl flex-shrink-0">
